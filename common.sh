...
export AGENT_E2E_TEST_INSTALL_CONFIG_AGENT_CONFIG=${AGENT_E2E_TEST_INSTALL_CONFIG_AGENT_CONFIG:-}
...
if [[ ! -z ${AGENT_E2E_TEST_SCENARIO} ]]; then
  ...
  #BAREMETAL_HA
  SCENARIO2=${AGENT_E2E_TEST_INSTALL_CONFIG_AGENT_CONFIG%%_IP*}
  case "$SCENARIO" "$SCENARIO2" in
      "COMPACT" )
